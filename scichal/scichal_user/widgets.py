...
# Based on
# http://stackoverflow.com/a/4733908
# https://github.com/django/django/blob/stable/1.6.x/django/forms/extras/widgets.py
# ... recreated for compatibility with Django 1.6 + Python 3.
